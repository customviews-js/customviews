/*!
 * @customviews-js/customviews v1.6.1-beta.0
...
(function (global, factory) {
    ...
    var root$g = from_html(`<div><div role="alert"><button class="close-btn svelte-ysaqmb" aria-label="Dismiss intro">×</button> <p class="text svelte-ysaqmb"> </p></div></div>`);
    ...
    var root$f = from_html(`<div role="button" tabindex="0" aria-label="Open Custom Views Settings"><span class="cv-gear svelte-122ln5">⚙</span></div>`);
  ...
  `.trim();
        ...
        static encodeState(state) {
            try {
                ...
                if (typeof btoa === 'function') {
                    ...
                    // Node/test fallback
                    encoded = globalThis.Buffer.from(json, 'utf-8').toString('base64');
                }
                // Make URL-safe
        ...
        static decodeState(encoded) {
            try {
                ...
                if (typeof atob === 'function') {
                    ...
                    // Node/test fallback
                    json = globalThis.Buffer.from(base64, 'base64').toString('utf-8');
                }
    ...
    var root$e = from_html(`<div class="card svelte-gwkhja"><div class="content svelte-gwkhja"><div><p class="title svelte-gwkhja"> </p> <!></div> <div class="radios svelte-gwkhja"><label class="radio-label svelte-gwkhja" title="Hide"><input class="toggle-input svelte-gwkhja" type="radio"/> <span>Hide</span></label> <label class="radio-label svelte-gwkhja" title="Peek"><input class="toggle-input svelte-gwkhja" type="radio"/> <span>Peek</span></label> <label class="radio-label svelte-gwkhja" title="Show"><input class="toggle-input svelte-gwkhja" type="radio"/> <span>Show</span></label></div></div></div>`);
    ...
    var root$d = from_html(`<div class="root svelte-uub3h8"><div class="header svelte-uub3h8"><label class="label svelte-uub3h8"> </label> <!></div> <select class="select svelte-uub3h8"></select></div>`);
    ...
    var root$c = from_html(`<div class="placeholder-item svelte-1vp05mb"><label class="placeholder-label svelte-1vp05mb"> </label> <input class="placeholder-input svelte-1vp05mb" type="text"/></div>`);
    ...
    var root_13 = from_html(`<button class="share-action-btn copy-url-btn svelte-16uy9h6"><span class="btn-icon svelte-16uy9h6"><!></span> <span><!></span></button>`);

    var root_12 = from_html(`<div class="tab-content active svelte-16uy9h6"><div class="share-content svelte-16uy9h6"><div class="share-instruction svelte-16uy9h6">Create a shareable link for your current customization, or select specific parts of
    			...
    			each(node_5, 16, () => get(sectionOrder), (section) => section, ($$anchor, section) => {
...

    				{
    					...
    					if_block(node_8, ($$render) => {
    						if (section === 'tabGroups' && showTabGroups() && get(tabGroups).length > 0) $$render(consequent_4);
    					});
    				}
    ...
    */
    ...
    var root$a = from_html(`<div class="toast-container svelte-zemmny"></div>`);

    const $$css$e = {
    	hash: 'svelte-zemmny',
    	code: '.toast-container.svelte-zemmny {position:fixed;top:20px;left:50%;transform:translateX(-50%);z-index:20000;display:flex;flex-direction:column;align-items:center;gap:10px;pointer-events:none; /* Let clicks pass through container */}.toast-item.svelte-zemmny {background:rgba(0, 0, 0, 0.85);color:white;padding:10px 20px;border-radius:4px;font-size:14px;box-shadow:0 4px 6px rgba(0, 0, 0, 0.1);pointer-events:auto; /* Re-enable clicks on toasts */max-width:300px;text-align:center;}'
    };
    ...
    function Toast($$anchor, $$props) {
    	...
    	each(div, 13, () => toast.items, (t) => t.id, ($$anchor, t) => {
    		...
    		template_effect(() => {
    			set_class(div_1, 1, `${TOAST_CLASS} toast-item`, 'svelte-zemmny');
    ...
    const $$css$a = {
    	hash: 'svelte-1yqpn7e',
    	code: '#cv-exit-focus-banner.svelte-1yqpn7e {position:fixed;top:0;left:0;right:0;background-color:#0078d4;color:white;padding:10px 20px;display:flex;align-items:center;justify-content:center;gap:16px;z-index:9000; /* Below Toast (usually 9999+) */font-family:system-ui, sans-serif;box-shadow:0 2px 8px rgba(0, 0, 0, 0.2);}button.svelte-1yqpn7e {background:white;color:#0078d4;border:none;padding:4px 12px;border-radius:4px;cursor:pointer;font-weight:600;}button.svelte-1yqpn7e:hover {background:#f0f0f0;}'
    };
    ...
    var root$6 = from_html(`<div class="cv-context-divider svelte-1a535nn" role="button" tabindex="0"> </div>`);
    ...
    var root$5 = from_html(`<div class="cv-highlight-overlay svelte-1mz0neo"></div>`);
    ...
    var root_1$2 = from_html(`<div class="cv-toggle-label svelte-1dbwn3b"> </div>`);
    var root_2$1 = from_html(`<button class="cv-expand-btn svelte-1dbwn3b"><!></button>`);
    var root$4 = from_html(`<div><!> <div class="cv-toggle-content svelte-1dbwn3b"><div class="cv-toggle-inner svelte-1dbwn3b"><!></div></div> <!></div>`);

    const $$css$6 = {
    	hash: 'svelte-1dbwn3b',
    	code: ':host {display:block;position:relative;z-index:1;overflow:visible;}\n\n  /* Host visibility control */:host([hidden]) {display:none;}.cv-toggle-wrapper.svelte-1dbwn3b {position:relative;width:100%;transition:all 0.3s ease;margin-bottom:4px;}.cv-toggle-wrapper.hidden.svelte-1dbwn3b {margin-bottom:0;}.cv-toggle-wrapper.peek-mode.svelte-1dbwn3b {margin-bottom:24px;}.cv-toggle-content.svelte-1dbwn3b {overflow:hidden;transition:max-height 0.3s ease,\n      opacity 0.3s ease,\n      overflow 0s 0s;\n    /* CSS max-height defaults are handled by inline styles now */}.cv-toggle-inner.svelte-1dbwn3b {display:flow-root; /* Ensures margins of children are contained */}\n\n  /* Hidden State */.hidden.svelte-1dbwn3b .cv-toggle-content:where(.svelte-1dbwn3b) {opacity:0;pointer-events:none;}\n\n  /* Bordered State */.has-border.svelte-1dbwn3b {box-sizing:border-box; /* Ensure padding/border doesn\'t increase width */\n\n    /* Dashed border */border:2px dashed rgba(0, 0, 0, 0.15);border-bottom:none;\n\n    /* Inner shadow to look like it\'s going into something + outer shadow */box-shadow:0 2px 8px rgba(0, 0, 0, 0.05),\n      /* Subtle outer */ inset 0 -15px 10px -10px rgba(0, 0, 0, 0.1); /* Inner bottom shadow */border-radius:8px 8px 0 0;padding:12px 0 0 0; /* bottom 0 px until expanded */margin-top:4px;}\n\n  /* Visible / Expanded State */.expanded.svelte-1dbwn3b .cv-toggle-content:where(.svelte-1dbwn3b) {opacity:1;transform:translateY(0);overflow:visible;transition:max-height 0.3s ease,\n      opacity 0.3s ease,\n      overflow 0s 0.3s;}\n\n  /* When expanded, complete the border */.has-border.expanded.svelte-1dbwn3b {border-bottom:2px dashed rgba(0, 0, 0, 0.15);border-radius:8px; /* Round all corners */padding-bottom:12px;box-shadow:0 2px 8px rgba(0, 0, 0, 0.05); /* Remove inner shadow when expanded */}\n\n  /* Peek State */.peeking.svelte-1dbwn3b .cv-toggle-content:where(.svelte-1dbwn3b) {opacity:1;\n    /* Mask for fade out effect */mask-image:linear-gradient(to bottom, black 50%, transparent 100%);-webkit-mask-image:linear-gradient(to bottom, black 50%, transparent 100%);}\n\n  /* Label Style */.cv-toggle-label.svelte-1dbwn3b {position:absolute;top:-12px;left:0;background:#e0e0e0;color:#333;font-size:0.75rem;font-weight:600;padding:2px 8px;border-radius:4px;z-index:10;pointer-events:auto;box-shadow:0 1px 2px rgba(0, 0, 0, 0.1);}\n\n  /* Adjust label position if bordered */.has-border.svelte-1dbwn3b .cv-toggle-label:where(.svelte-1dbwn3b) {top:-10px;left:0;}\n\n  /* Expand Button */.cv-expand-btn.svelte-1dbwn3b {position:absolute;bottom:-24px;left:50%;transform:translateX(-50%);display:flex;background:transparent;border:none;border-radius:50%;padding:4px;width:32px;height:32px;cursor:pointer;z-index:100;align-items:center;justify-content:center;color:#888;transition:all 0.2s ease;}.cv-expand-btn.svelte-1dbwn3b:hover {background:rgba(0, 0, 0, 0.05);color:#000;transform:translateX(-50%) scale(1.1);}\n\n  /* Accessing SVG inside button - might need :global if SVG is injected as HTML or just plain styles since it adheres to current scope */.cv-expand-btn.svelte-1dbwn3b svg {display:block;opacity:0.6;width:24px;height:24px;transition:opacity 0.2s;}.cv-expand-btn.svelte-1dbwn3b:hover svg {opacity:1;}'
    };
    ...
    function Toggle($$anchor, $$props) {
    	...
    	template_effect(() => {
    		classes = set_class(div, 1, 'cv-toggle-wrapper svelte-1dbwn3b', null, classes, {
    ...
    const $$css$5 = {
    	hash: 'svelte-1hy6z32',
    	code: ':host {display:block;}:host(.cv-hidden) {display:none !important;}:host(.cv-visible) {display:block !important;}:host([active=\'true\']) {display:block;}.cv-tab-content.svelte-1hy6z32 {display:none;\n    animation: svelte-1hy6z32-fade-in 0.2s ease-in-out;padding-top:1rem;padding-bottom:0.5rem;padding-left:0;padding-right:0;}.cv-tab-content.active.svelte-1hy6z32 {display:block;}\n\n  /* Hide cv-tab-header source element; content is extracted to nav link */.svelte-1hy6z32::slotted(cv-tab-header) {display:none !important;}\n\n  /* Allow cv-tab-body to flow naturally */.svelte-1hy6z32::slotted(cv-tab-body) {display:block;}\n\n  @keyframes svelte-1hy6z32-fade-in {\n    from {\n      opacity: 0;\n    }\n    to {\n      opacity: 1;\n    }\n  }'
    };
    ...
    function Tab($$anchor, $$props) {
    	...
    	reset(div);
    	template_effect(() => classes = set_class(div, 1, 'cv-tab-content svelte-1hy6z32', null, classes, { active: active() }));
    	append($$anchor, div);
    ...
    var root_2 = from_html(`<li class="nav-item svelte-xqnrrx"><a role="tab" title="Double-click a tab to 'pin' it in all similar tab groups."><span class="cv-tab-header-container svelte-xqnrrx"><span class="cv-tab-header-text svelte-xqnrrx"><!></span> <span class="cv-tab-pin-icon svelte-xqnrrx"><!></span></span></a></li>`);
    var root_1$1 = from_html(`<ul class="cv-tabs-nav nav-tabs svelte-xqnrrx" role="tablist"></ul>`);
    var root_3 = from_html(`<link rel="stylesheet"/>`);
    var root$2 = from_html(`<div class="cv-tabgroup-container"><!> <!> <div class="cv-tabgroup-content"><!></div> <div class="cv-tabgroup-bottom-border svelte-xqnrrx"></div></div>`);

    const $$css$4 = {
    	hash: 'svelte-xqnrrx',
    	code: ':host {display:block;margin-bottom:24px;}\n\n  /* Tab navigation styles */ul.nav-tabs.svelte-xqnrrx {display:flex;flex-wrap:wrap;padding-left:0;margin-top:0.5rem;margin-bottom:0;list-style:none;border-bottom:1px solid #dee2e6;align-items:stretch;}.nav-item.svelte-xqnrrx {margin-bottom:-1px;list-style:none;display:flex;align-items:stretch;}.nav-link.svelte-xqnrrx {display:flex;align-items:center;justify-content:center;padding:0.5rem 1rem;color:#495057;text-decoration:none;background-color:transparent;border:1px solid transparent;border-top-left-radius:0.25rem;border-top-right-radius:0.25rem;transition:color 0.15s ease-in-out,\n      background-color 0.15s ease-in-out,\n      border-color 0.15s ease-in-out;cursor:pointer;min-height:2.5rem;box-sizing:border-box;}.nav-link.svelte-xqnrrx p {margin:0;display:inline;}.nav-link.svelte-xqnrrx:hover,\n  .nav-link.svelte-xqnrrx:focus {border-color:#e9ecef #e9ecef #dee2e6;isolation:isolate;}.nav-link.active.svelte-xqnrrx {color:#495057;background-color:#fff;border-color:#dee2e6 #dee2e6 #fff;}.nav-link.svelte-xqnrrx:focus {outline:0;}.cv-tab-header-container.svelte-xqnrrx {display:flex;align-items:center;gap:6px;}.cv-tab-header-text.svelte-xqnrrx {flex:1;}.cv-tab-pin-icon.svelte-xqnrrx {display:inline-flex;align-items:center;line-height:0;flex-shrink:0;}.cv-tab-pin-icon.svelte-xqnrrx svg {vertical-align:middle;width:14px;height:14px;}.cv-tabgroup-bottom-border.svelte-xqnrrx {border-bottom:1px solid #dee2e6;}\n\n  @media print {ul.cv-tabs-nav.svelte-xqnrrx {display:none !important;}\n  }'
    };
...

    	{
    		var consequent = ($$anchor) => {
    			...
    			each(ul, 21, () => get(tabs), (tab) => tab.id, ($$anchor, tab) => {
    				...
    				template_effect(() => {
    					classes = set_class(a, 1, 'nav-link svelte-xqnrrx', null, classes, { active: get(isActive) });
    ...
    const $$css$2 = { hash: 'svelte-1gw0vk2', code: ':host {display:block;}' };
