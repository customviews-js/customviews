...
(function (global, factory) {
    ...
    var root$g = from_html(`<div><div role="alert"><button class="close-btn svelte-1jgbyi0" aria-label="Dismiss intro">×</button> <p class="text svelte-1jgbyi0"> </p></div></div>`);
    ...
    var root$f = from_html(`<div role="button" tabindex="0" aria-label="Open Custom Views Settings"><span class="cv-gear svelte-11erbyi">⚙</span></div>`);
    ...
    function SettingsIcon($$anchor, $$props) {
    	...
    	let position = prop($$props, 'position', 3, 'middle-left'),
    		...
    		persistence = prop($$props, 'persistence', 3, undefined);
    	...
    	onMount(() => {
    		...
    		if (persistence()) {
    			...
    			if (savedPosition) {
    				set(currentOffset, parseFloat(savedPosition), true);
    			}
    		}
    	...
    	function savePosition() {
    		if (persistence()) {
    			persistence().setItem(STORAGE_KEY_BASE, get(currentOffset).toString());
    		}
    	}
  ...
  `.trim();
    ...
    var root_1$a = from_html(`<p class="description svelte-dp7a9f"> </p>`);
    var root$e = from_html(`<div class="card svelte-dp7a9f"><div class="content svelte-dp7a9f"><div><p class="title svelte-dp7a9f"> </p> <!></div> <div class="radios svelte-dp7a9f"><label class="radio-label svelte-dp7a9f" title="Hide"><input class="toggle-input svelte-dp7a9f" type="radio"/> <span>Hide</span></label> <label class="radio-label svelte-dp7a9f" title="Peek"><input class="toggle-input svelte-dp7a9f" type="radio"/> <span>Peek</span></label> <label class="radio-label svelte-dp7a9f" title="Show"><input class="toggle-input svelte-dp7a9f" type="radio"/> <span>Show</span></label></div></div></div>`);
    ...
    var root_1$9 = from_html(`<p class="description svelte-741mad"> </p>`);
    var root_2$4 = from_html(`<option> </option>`);
    var root$d = from_html(`<div class="root svelte-741mad"><div class="header svelte-741mad"><label class="label svelte-741mad"> </label> <!></div> <select class="select svelte-741mad"></select></div>`);
    ...
    var root$c = from_html(`<div class="placeholder-item svelte-1xj6dyw"><label class="placeholder-label svelte-1xj6dyw"> </label> <input class="placeholder-input svelte-1xj6dyw" type="text"/></div>`);

    const $$css$g = {
    	hash: 'svelte-1xj6dyw',
    	code: '.placeholder-item.svelte-1xj6dyw {display:flex;flex-direction:column;gap:0.25rem;}.placeholder-label.svelte-1xj6dyw {font-size:0.85rem;font-weight:500;color:var(--cv-text);}.placeholder-input.svelte-1xj6dyw {padding:0.5rem 0.75rem;border:1px solid var(--cv-input-border);border-radius:0.375rem;font-size:0.9rem;transition:border-color 0.2s;background:var(--cv-input-bg);color:var(--cv-text);}.placeholder-input.svelte-1xj6dyw:focus {outline:none;border-color:var(--cv-primary);box-shadow:0 0 0 2px var(--cv-focus-ring);}'
    };
    ...
    var root_3$2 = from_html(`<p class="description svelte-1tduk3b"> </p>`);
    var root_5 = from_html(`<div class="section svelte-1tduk3b"><div class="section-heading svelte-1tduk3b">Toggles</div> <div class="toggles-container svelte-1tduk3b"></div></div>`);
    var root_7 = from_html(`<div class="section svelte-1tduk3b"><div class="section-heading svelte-1tduk3b">Placeholders</div> <div class="placeholders-container svelte-1tduk3b"></div></div>`);
    ...
    function Modal($$anchor, $$props) {
    	...
    	const store = user_derived(() => $$props.controller.store);

    	const areTabNavsVisible = user_derived(() => get(store).isTabGroupNavHeadingVisible);

    	// Config Items
    	const toggles = user_derived(() => get(store).menuToggles);

    	const tabGroups = user_derived(() => get(store).menuTabGroups);
    	const sectionOrder = user_derived(() => get(store).configSectionOrder);
    	...
    	let placeholderValues = user_derived(() => placeholderValueStore.values);

    	// --- UI Logic ---
    	let hasCustomizeContent = user_derived(() => get(toggles).length > 0 || get(placeholderDefinitions).length > 0 || showTabGroups() && get(tabGroups).length > 0);
    	...
    	user_effect(() => {
    		updateNavIcon(get(areTabNavsVisible), false);
    	});
    	...
    	function handleNavHover(hovering) {
    		updateNavIcon(get(areTabNavsVisible), hovering);
    	}

    	function handleNavToggle() {
    		get(store).isTabGroupNavHeadingVisible = !get(areTabNavsVisible);
    	}
...

    	{
    		var consequent = ($$anchor) => {
    			...
    			template_effect(() => set_class(button_1, 1, `tab ${get(activeTab) === 'customize' ? 'active' : ''}`, 'svelte-1tduk3b'));
...

    	{
    		var consequent_6 = ($$anchor) => {
    			...
    			each(node_5, 17, () => get(sectionOrder), index, ($$anchor, section) => {
    				var fragment = root_4();
...

    				{
    					...
    					if_block(node_6, ($$render) => {
    						if (get(section) === 'toggles' && get(toggles).length > 0) $$render(consequent_2);
    					});
    				}
...

    				{
    					...
    					if_block(node_7, ($$render) => {
    						if (get(section) === 'placeholders' && get(placeholderDefinitions).length > 0) $$render(consequent_3);
    					});
    				}
...

    				{
    					...
    					if_block(node_8, ($$render) => {
    						if (get(section) === 'tabGroups' && showTabGroups() && get(tabGroups).length > 0) $$render(consequent_4);
    					});
    				}
    		...
    		var alternate_2 = ($$anchor) => {
    			...
    			var button_5 = sibling(child(div_21), 2);
...

    			{
    				var consequent_9 = ($$anchor) => {
...

    					{
    						...
    						var alternate = ($$anchor) => {
    							...
    							html(node_17, getCopyIcon);
    							append($$anchor, fragment_5);
    						};

    						if_block(node_15, ($$render) => {
    							if (get(copySuccess)) $$render(consequent_7); else $$render(alternate, false);
    						});
    					}
...

    					{
    						...
    						if_block(node_18, ($$render) => {
    							if (get(copySuccess)) $$render(consequent_8); else $$render(alternate_1, false);
    						});
    					}
    				...
    				if_block(node_14, ($$render) => {
    					if (get(hasCustomizeContent)) $$render(consequent_9);
    				});
    			}
    		...
    		if_block(node_3, ($$render) => {
    			if (get(activeTab) === 'customize') $$render(consequent_6); else $$render(alternate_2, false);
    		});
    	}
...

    	{
    		var consequent_10 = ($$anchor) => {
    			...
    			var node_20 = child(span_3);

    			html(node_20, getResetIcon);
    			reset(span_3);
    			next(2);
    			reset(button_7);
    		...
    		if_block(node_19, ($$render) => {
    			if (showReset()) $$render(consequent_10); else $$render(alternate_3, false);
    		});
    	}

    	var a = sibling(node_19, 2);
    	var node_21 = child(a);

    	html(node_21, getGitHubIcon);
    	next(2);
    	reset(a);
    ...
    */
    ...
    var root$a = from_html(`<div class="toast-container svelte-8xfcdj"></div>`);
    ...
    function ShareToolbar($$anchor, $$props) {
    	...
    	template_effect(() => {
    		set_class(button, 1, `mode-btn ${shareStore.selectionMode === 'show' ? 'active' : ''}`, 'svelte-s43aqa');
    ...
    var root_2$2 = from_html(`<span class="id-badge svelte-2rmv56" title="ID detection active"> </span>`);
    var root_3$1 = from_html(`<button class="action-btn up svelte-2rmv56" title="Select Parent">↰</button>`);
    var root_1$6 = from_html(`<div class="hover-helper svelte-2rmv56"><div class="info svelte-2rmv56"><span class="tag svelte-2rmv56"> </span> <!></div> <button> </button> <!></div>`);
    ...
    var root_1$5 = from_html(`<div><span class="selection-label svelte-ou9w9b"> </span></div>`);
    var root$8 = from_html(`<div class="share-overlay-ui"><!> <!> <!></div>`);
    ...
    var root_1$4 = from_html(`<div id="cv-exit-focus-banner" class="svelte-1iowue5"><span>You are viewing a focused selection.</span> <button class="svelte-1iowue5">Show Full Page</button></div>`);
    ...
    class IntroManager {
    	...
    	constructor(persistence, options) {
    		this.getPersistence = typeof persistence === 'function' ? persistence : () => persistence;
    ...
    var root$7 = from_html(`<div class="cv-widget-root"><!> <!> <!> <!> <!> <!></div>`);
    ...
    function UIRoot($$anchor, $$props) {
    	...
    	const storeConfig = user_derived(() => $$props.controller.store.config);
    	const settingsEnabled = user_derived(() => $$props.options.settingsEnabled ?? true);

    	// --- Services ---
    	const introManager = new IntroManager(() => $$props.controller.persistenceManager, () => $$props.options.callout);
    	...
    	function initTheme() {
    		themeStore.init($$props.controller.persistenceManager);
    	}

    	// --- Effects ---
    	user_effect(() => {
    		introManager.init(get(store).hasPageElements, get(settingsEnabled));
    	});
    	...
    	function handleReset() {
    		...
    		$$props.controller.resetToDefault();
    	...
    	function handleStartShare(mode) {
    		closeModal();
    	...
    	// --- Settings Visibility ---
    	const shouldRenderSettings = user_derived(() => get(settingsEnabled) && (get(store).hasMenuOptions || $$props.options.panel.showTabGroups || get(isModalOpen)));
    		...
    		var consequent_2 = ($$anchor) => {
    			{
    				...
    				bind_this(
    					SettingsIcon($$anchor, {
    						...
    						get persistence() {
    							return $$props.controller.persistenceManager;
    						}
    					}),
     ...
     */
    function initUIManager(controller, config) {
    ...
    var root$6 = from_html(`<div class="cv-context-divider svelte-1x6h5hk" role="button" tabindex="0"> </div>`);
    ...
    var root_1$3 = from_html(`<div class="cv-highlight-box svelte-1fie5i7"></div> <div> </div>`, 1);
    var root$5 = from_html(`<div class="cv-highlight-overlay svelte-1fie5i7"></div>`);

    const $$css$7 = {
    	hash: 'svelte-1fie5i7',
    	code: '.cv-highlight-overlay.svelte-1fie5i7 {position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;z-index:8000;overflow:visible;}.cv-highlight-box.svelte-1fie5i7 {position:absolute;\n    /* Slightly thicker border looks more like a marker stroke */border:5px solid #d13438;box-sizing:border-box;\n\n    /* Top-Left: 5px (Sharp)\n      Top-Right: 80px\n      Bottom-Right: 40px\n      Bottom-Left: 100px\n      (Separated by the slash for organic asymmetry)\n      Horizontal Radius / Vertical Radius\n    */border-radius:200px 15px 225px 15px / 15px 225px 15px 255px;\n\n    /* A subtle transform to make it look slightly tilted/imperfect */transform:rotate(-0.5deg);\n\n    /* Balanced shadows from before, but adjusted for the wobble */box-shadow:0 6px 15px rgba(0, 0, 0, 0.13), \n      /* The inset shadow now follows the wobbly border-radius */\n      inset 0 0 8px 1px rgba(0, 0, 0, 0.12);pointer-events:none;\n    /* Smoother rendering for the wobbled edges */backface-visibility:hidden;opacity:0.92;}.cv-highlight-arrow.svelte-1fie5i7 {position:absolute;font-size:35px; /* Slightly larger for the "marker" feel */color:#d13438;font-weight:bold;width:40px;height:40px;line-height:40px;text-align:center;\n    \n    /* Hand-drawn style for the arrow: \n       1. Slight tilt to match the box\n       2. Multi-layer drop shadow to match the box\'s elevation \n    */transform:rotate(3deg);filter:drop-shadow(2px 4px 6px rgba(0, 0, 0, 0.15))\n      drop-shadow(0 1px 2px rgba(0, 0, 0, 0.1));}\n\n  /* Animations set to run 4 times and stop (forwards) */.cv-highlight-arrow.left.svelte-1fie5i7 { animation: svelte-1fie5i7-floatArrowLeft 1.5s 4 forwards;}.cv-highlight-arrow.right.svelte-1fie5i7 { animation: svelte-1fie5i7-floatArrowRight 1.5s 4 forwards;}.cv-highlight-arrow.top.svelte-1fie5i7 { animation: svelte-1fie5i7-floatArrowTop 1.5s 4 forwards;}.cv-highlight-arrow.bottom.svelte-1fie5i7 { animation: svelte-1fie5i7-floatArrowBottom 1.5s 4 forwards;}\n\n  @keyframes svelte-1fie5i7-floatArrowLeft {\n      0%, 100% { transform: translateX(0); }\n      50% { transform: translateX(-10px); }\n  }\n  @keyframes svelte-1fie5i7-floatArrowRight {\n      0%, 100% { transform: translateX(0); }\n      50% { transform: translateX(10px); }\n  }\n  @keyframes svelte-1fie5i7-floatArrowTop {\n      0%, 100% { transform: translate(-50%, 0); }\n      50% { transform: translate(-50%, -10px); }\n  }\n  @keyframes svelte-1fie5i7-floatArrowBottom {\n      0%, 100% { transform: translate(-50%, 0); }\n      50% { transform: translate(-50%, 10px); }\n  }'
    };
    ...
    /* controller.svelte.ts generated by Svelte v5.46.1 */
    ...
    var root_1$2 = from_html(`<div class="cv-toggle-label svelte-1x95rqi"> </div>`);
    var root_2$1 = from_html(`<button class="cv-expand-btn svelte-1x95rqi"><!></button>`);
    var root$4 = from_html(`<div><!> <div class="cv-toggle-content svelte-1x95rqi"><div class="cv-toggle-inner svelte-1x95rqi"><!></div></div> <!></div>`);
    ...
    var root_1$1 = from_html(`<ul class="cv-tabs-nav nav-tabs svelte-1630cmg" role="tablist"></ul>`);
    var root_3 = from_html(`<link rel="stylesheet"/>`);
    var root$2 = from_html(`<div class="cv-tabgroup-container"><!> <!> <div class="cv-tabgroup-content"><!></div> <div class="cv-tabgroup-bottom-border svelte-1630cmg"></div></div>`);
    ...
    const $$css$2 = { hash: 'svelte-zu6cbf', code: ':host {display:block;}' };
    ...
    const $$css$1 = { hash: 'svelte-1tdaot', code: ':host {display:inline;}' };
    ...
    var root_1 = from_html(`<label class="placeholder-label svelte-15mojkt"> </label>`);
    var root = from_html(`<div class="cv-input-wrapper svelte-15mojkt"><!> <input class="placeholder-input svelte-15mojkt" type="text"/></div>`);

    const $$css = {
    	hash: 'svelte-15mojkt',
    	code: ':host {display:inline-block;width:100%;margin-bottom:0.5rem;}\n\n  /* Reuse styles from Modal/Settings */.cv-input-wrapper.svelte-15mojkt {display:flex;flex-direction:column;gap:0.25rem;}.placeholder-label.svelte-15mojkt {font-size:0.85rem;font-weight:500;color:var(--cv-text, #333);margin-bottom:2px;}.placeholder-input.svelte-15mojkt {padding:0.5rem 0.75rem;border:1px solid var(--cv-input-border, rgba(0,0,0,0.1));border-radius:0.375rem;font-size:0.9rem;transition:border-color 0.2s;background:var(--cv-input-bg, white);color:var(--cv-text, #333);width:100%;box-sizing:border-box;}.placeholder-input.svelte-15mojkt:focus {outline:none;border-color:var(--cv-primary, #3e84f4);box-shadow:0 0 0 2px var(--cv-focus-ring, rgba(62, 132, 244, 0.2));}'
    };
